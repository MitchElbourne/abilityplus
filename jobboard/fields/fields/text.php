...
$tempdate = strToTime("-10 year", time());

if($input == "date") { ?>
  <input id="<?php echo esc_attr($id); ?>" type="<?php echo esc_attr($input); ?>" class="<?php echo esc_attr($type); ?>" name="<?php echo esc_attr($name); ?>" value="<?php echo esc_attr($value); ?>" max="<?php echo date('Y-m-d', $tempdate) ?>" placeholder="<?php echo esc_attr($placeholder); ?>">
<?php } else { ?>
