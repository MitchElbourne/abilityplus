...
run_activate_plugin( 'jobboard/jobboard.php' );
...
add_action ('wp_nav_menu_items', function( $menu_items, $menu_object ){
  ...
  if ( 'Navigation' === $menu_name && !is_user_logged_in()) {
    ...
    <li itemscope='itemscope' itemtype='https://www.schema.org/SiteNavigationElement' id='logged-in-dropdown' class='menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children dropdown logged-in logged-in-dropdown nav-item'>
      <a href='#' data-toggle='dropdown' aria-haspopup='true' aria-expanded='false' class='dropdown-toggle nav-link' id='logged-in-dropdown-menu'>" . $firstName . " " . $lastName . "</a>
