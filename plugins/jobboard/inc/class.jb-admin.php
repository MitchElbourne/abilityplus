            ...
            $sections = array(
                'general-setting' => array(
                    ...
                    'fields' => array(
                        ...
                        array(
                            'id' => 'view-user-detail-require-login',
                            'type' => 'switch',
                            'title' => esc_html__('User login view Profile', JB_TEXT_DOMAIN),
                            'subtitle' => esc_html__('Require login to view User Profile Details.', JB_TEXT_DOMAIN),
                            'default' => false,
                        ),
                        array(
                            'id' => 'view-user-detail-require-package',
                            'type' => 'switch',
                            'title' => esc_html__('Buy Package view Profile', JB_TEXT_DOMAIN),
                            'subtitle' => esc_html__('Require Package to view User Profile Details.', JB_TEXT_DOMAIN),
                            'default' => false,
                        ),
                    )
                ),
                'page-setting' => array(
                    ...
                    'fields' => array(
                        ...
                        array(
                            ...
                            'type' => 'select',
                            'data' => 'pages',
                            'title' => esc_html__('Specializations List', JB_TEXT_DOMAIN),
                            'subtitle' => esc_html__('Page for Specializations List.', JB_TEXT_DOMAIN),
                        ),
                        array(
                            'id' => 'page-locations',
                            'type' => 'select',
                ...
                'seo-optimization' => array(
                    ...
                    'fields' => array(
                        ...
                        array(
                            ...
                            'type' => 'text',
                            'title' => esc_html__('Specialization Slug', JB_TEXT_DOMAIN),
                            'subtitle' => esc_html__('Custom base slug for "Specialization" taxonomy.', JB_TEXT_DOMAIN),
                            'placeholder' => esc_html__('specialization', JB_TEXT_DOMAIN),
                        ),
                        array(
