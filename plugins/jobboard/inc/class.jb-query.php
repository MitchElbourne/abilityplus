...
if (!class_exists('JobBoard_Query')) :
    class JobBoard_Query
    {
        ...
        function job_query($q)
        {
            ...
            // $q->set('tax_career_query', $this->get_filter_career_level_query($q->get('tax_career_query')), 2);
        ...
        function get_filter_specialism_query($tax_query = array())
        {
            ...
            $careerLevels = !empty($_GET['career-levels']) ? $_GET['career-levels'] : (!empty($_GET['career-levels']) ? $_GET['career-levels'] : '');
        ...
        // function get_filter_career_level_query($tax_career_query = array())
        // {

        //     if (!is_array($tax_career_query)) {
        //         $tax_career_query = array();
        //     }
        ...
        //             'operator' => 'IN',
        //         );
        //         $tax_career_query['relation'] = 'AND';
        //     }

        //     return apply_filters('jb/query/filter/career-levels', $tax_career_query, $this);
        // }
