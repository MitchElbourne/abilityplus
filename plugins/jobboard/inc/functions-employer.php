        ...
        foreach ($fields as $key => $field) {
            if ($field['id'] == 'job_specialisms') {
                $fields[$key] = array(
                    ...
                    'subtitle' => esc_html__('Specializations Group', 'jobboard-register'),
                    'fields' => array(
...
function jb_employer_job_custom_field(){
    $fields     = array(
        ...
        array (
            'id'         => 'specialisms',
            'name'       => 'specialisms[]',
            'title'      => esc_html__('Specializations & Skill', JB_TEXT_DOMAIN ),
            'subtitle'   => esc_html__('Select specializations and skill for job.', JB_TEXT_DOMAIN ),
            'notice'     => esc_html__('is required !', JB_TEXT_DOMAIN),
            'placeholder'=> esc_html__('Specializations & Skill *', JB_TEXT_DOMAIN ),
            'type'       => 'select',
            'multi'      => true,
            'col'        => 6,
            'require'    => 1,
