	...
	class JobBoard_Post {
		...
		function post_types() {
			...
			$job_specialism_labels = array(
				'name'              => esc_html__( 'Specializations', JB_TEXT_DOMAIN ),
				'singular_name'     => esc_html__( 'Specialization', JB_TEXT_DOMAIN ),
				'search_items'      => esc_html__( 'Search Specializations', JB_TEXT_DOMAIN ),
				'all_items'         => esc_html__( 'All Specializations', JB_TEXT_DOMAIN ),
				'parent_item'       => esc_html__( 'Parent Specialization', JB_TEXT_DOMAIN ),
				'parent_item_colon' => esc_html__( 'Parent Specialization:', JB_TEXT_DOMAIN ),
				'edit_item'         => esc_html__( 'Edit Specialization', JB_TEXT_DOMAIN ),
				'update_item'       => esc_html__( 'Update Specialization', JB_TEXT_DOMAIN ),
				'add_new_item'      => esc_html__( 'Add New Specialization', JB_TEXT_DOMAIN ),
				'new_item_name'     => esc_html__( 'New Specialization', JB_TEXT_DOMAIN ),
				'menu_name'         => esc_html__( 'Specializations', JB_TEXT_DOMAIN ),
			);
		...
		function sections_job() {
			$sections = array(
              ...
              'id'          => '_salary_extra',
							'type'        => 'text',
							'title'       => esc_html__( 'Custom Salary', JB_TEXT_DOMAIN ),
							'subtitle'    => esc_html__( 'Enter in a custom salary if applicable', JB_TEXT_DOMAIN ),
							'placeholder' => esc_html__( 'E.g. Upon enquiry or Negotiable', JB_TEXT_DOMAIN )
            ),
            array(
              'id'       => '_salary_currency',
              'type'     => 'select',
				...
				'basic' => array(
					...
					'fields' => array(
						array(
							...
							'subtitle' => esc_html__( 'You can select icon or image for specialization', JB_TEXT_DOMAIN ),
							'default'  => true,
							'on'       => 'Icon(Class)',
							'off'      => 'Image (jpg, png..)',
						),
