...
if(!class_exists('JobBoard_Emails')) {
    ...
    class JobBoard_Emails
    {
        ...
        function __construct($to = '', $from = '', $reply = '', $subject = '', $message = '', $headers = array(), $attachments = array())
        {
            ...
            add_action('jobboard_email_footer', array($this, 'email_footer'));
        }
         ...
         * Date: 04/12/2018
         * Editer: TuanNA
         * Description: Change received email (admin email) when approved or rejected application become to candidate's email
         */
