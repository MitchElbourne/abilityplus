...
class JB_Widget_Specialism_Filters extends JB_Widget {
	...
	public function __construct() {
		...
		$this->widget_description = esc_html__( 'A Specialization filters box for JobBoard only.', JB_TEXT_DOMAIN );
		$this->widget_id          = 'jobboard-widget-specialism-filters';
		$this->widget_name        = esc_html__( 'JobBoard Specialization Filters', JB_TEXT_DOMAIN );
		$this->settings           = array(
			'title'  => array(
				'type'  => 'text',
