...
class JB_Widget_Specialism_List extends JB_Widget {
	...
	public function __construct() {
		...
		$this->widget_description = esc_html__( 'A list of jobboard specializations.', JB_TEXT_DOMAIN );
		$this->widget_id          = 'jobboard-widget-specialism-list';
		$this->widget_name        = esc_html__( 'JobBoard Specialization List', JB_TEXT_DOMAIN );
		$this->settings           = array(
			'title'  => array(
				'type'  => 'text',
	...
	public function widget( $args, $instance ) {
        ...
        $list_args['show_option_none']           = esc_html__('Specialization does not exists.', JB_TEXT_DOMAIN );
