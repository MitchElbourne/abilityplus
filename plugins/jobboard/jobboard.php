...
if ( !is_plugin_active( 'rc-framework/rc-framework.php' ) ) {
    return;
}
...
//            require_once $this->plugin_directory . 'update/update-manager.php';
        ...
        function add_scripts()
        {
            ...
            wp_enqueue_script('group-field-js', $this->plugin_directory_uri . 'assets/js/group-field.js', array('jquery'), time(), true);
            ...
            if (isset($screen->id)) {
                switch ($screen->id) {
                    ...
                    case 'user-edit':
                        ...
                        wp_enqueue_style('jobboard-user-profile', $this->plugin_directory_uri . 'assets/css/user-profile.css');
                        wp_enqueue_script('group-field-js', $this->plugin_directory_uri . 'assets/js/group-field.js', array('jquery'), time(), true);
                        wp_enqueue_style('group-field-css', $this->plugin_directory_uri . 'assets/css/group-field.css');
                        break;
                }
            }
        }
...
if(!function_exists('jobboard_formhandler')){
    function jobboard_formhandler(){
        return JobBoard_FormHandler::getInstance();
    }
}