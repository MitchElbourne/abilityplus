...
<select id="<?php echo esc_attr($id); ?>" name="<?php echo esc_attr($name); ?>" class="<?php echo esc_attr($type); ?>"
        data-placeholder="<?php echo esc_attr($placeholder); ?>"<?php jb_multiple($multi); ?>>
